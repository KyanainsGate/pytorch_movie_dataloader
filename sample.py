...
from method_utils import make_datapath_list, get_c2i_i2c_from_dir_hrc, show_img, get_mean_and_std

if __name__ == '__main__':
    # vieo_listの作成
    root_path = 'data/kinetics_images'
    ...
    val_dataset = VideoDataset(video_list,
                               ...
                               # path_delim="\\",  # for windows configuration
                               path_delim="/",  # for Linux configuration
                               slash_sp_num=2,
